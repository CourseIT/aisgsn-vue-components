...
<!-------------------------------- time-btn -------------------------------->
    ...
    <div style="width: 70%; margin-top: 50px; margin-bottom: 100px;">
            ...
            <v-input-date-range v-model="test_date2" />
            <v-input-date v-model="test_date" />
...
export default {
  ...
  data: () => ({
    ...
    value11: '',
    value12: '',
    buttons: ['Выбор 1', 'Выбор 2', 'Выбор 3', 'Выбор 4', 'Выбор 2', 'Выбор 3', 'Выбор 4', 'Выбор 2', 'Выбор 3', 'Выбор 4', 'Выбор 2', 'Выбор 3', 'Выбор 4'],
