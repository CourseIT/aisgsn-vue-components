...
<!-------------------------------- time-btn -------------------------------->
    ...
    <!-------------------------------- news-feed -------------------------------->
    <v-news-feed>
      <v-news v-for="(news,index) in news_list" :key="index" :news="news" :max_title_length="200" :max_text_length="200"/>
    </v-news-feed>
    <!-------------------------------- news-feed -------------------------------->
  ...
  data: () => ({
    ...
    news_list: [
      ...
      },
      {
        ...
        date: '21.02.2020',
        time: '12:32',
        title: 'Итоги реализации региональных проектов в 2019 году проанализированы в администрации области',
        text: 'Заседание координационного Совета по проектному управлению в Липецкой области состоялось сегодня в администрации…',
        provider: 'Новостное агентство Липецк ньюс'
      },
      {
        src: 'https://lipetsknews.ru/files/styles/articles2/public/articles/1_23.jpg?itok=Yu6fe7OA',
