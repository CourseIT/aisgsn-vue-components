    ...
    analytics: {
      ...
      list: [
        ...
        },
        {
          ...
          color: '#4cd964',
          section: '1.4',
          text: 'Количество неустраненных нарушений'
        },
        {
          x: 'xxx',
          plus: '+x',
          ...
          color: '#4cd964',
          section: '1.5',
          text: 'Количество вводных объектов ФЯО'
        },
        {
          x: 'xxx',
          plus: '+x',
